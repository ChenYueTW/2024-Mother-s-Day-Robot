...
public class SwerveDriveCmd extends Command {
	...
	@Override
	public void execute() {
		double xSpeed =MathUtil.applyDeadband(this.controller.getLeftX(), Constants.DEAD_BAND) * Constants.MAX_SPEED;
		double ySpeed = MathUtil.applyDeadband(this.controller.getLeftY(), Constants.DEAD_BAND) * Constants.MAX_SPEED;
